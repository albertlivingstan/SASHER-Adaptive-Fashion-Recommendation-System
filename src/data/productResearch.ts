...
const RAW_SEEDS: RawProductSeed[] = [
  ...
  },
  {
    ...
    silhouette: 'M 36 15 L 64 15 L 82 34 L 75 55 L 72 90 L 28 90 L 25 55 L 18 34 Z',
    materialDesc: '90% Wool / 10% Cashmere double cloth',
    keyFeature: 'Concealed magnetic placket closure',
    anchorSeam: 'Curved cocoon sleeve pitch',
    rigidity: 93, gazeAffinity: 97, crossSell: 85, inelasticity: 97, longevity: 99, density: 96, coldStart: 90
  },
  {
    id: 'prod-11',
  ...
  {
    id: 'prod-39',
    name: 'Silk Organza Layered Evening Dress',
    brand: 'SARTORIAL SILK',
    category: 'Outerwear',
    releaseYear: 2023,
    price: 34000,
    image: 'https://images.unsplash.com/photo-1566174053879-31528523f8ae?auto=format&fit=crop&w=800&q=80',
    silhouette: 'M 38 18 L 62 18 L 68 38 L 74 58 L 84 92 L 16 92 L 26 58 L 32 38 Z',
    materialDesc: 'Triple-layer sheer silk organza 12mm',
    keyFeature: 'Architectural translucent silhouette shadow',
    anchorSeam: 'Hand-rolled baby hem throughout all flounces',
    rigidity: 87, gazeAffinity: 99, crossSell: 81, inelasticity: 99, longevity: 98, density: 80, coldStart: 88
  },
  {
    id: 'prod-40',
  ...
  {
    id: 'prod-50',
    name: 'Architectural Pleated Silk Midi Dress',
    brand: 'KINETIC DRAPE',
    category: 'Outerwear',
    releaseYear: 2024,
    price: 29500,
    image: 'https://images.unsplash.com/photo-1566174053879-31528523f8ae?auto=format&fit=crop&w=800&q=80',
    silhouette: 'M 38 18 L 62 18 L 68 38 L 74 58 L 84 92 L 16 92 L 26 58 L 32 38 Z',
    materialDesc: 'Permanent heat-set pleated silk satin',
    keyFeature: 'Radial pleats expanding dynamically with motion',
    anchorSeam: 'High asymmetric architectural neckline',
    rigidity: 86, gazeAffinity: 98, crossSell: 84, inelasticity: 98, longevity: 97, density: 83, coldStart: 88
  },
  {
    id: 'prod-51',
